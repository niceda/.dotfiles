...
docker run -d --platform linux/amd64 --name dev -p 2222:22 -p 8000:8000 -p 8001:8001 -p 8002:8002 --privileged=true -v "$HOME/Documents/Code/qz/":/Users/fida/Documents/Code/qz -v "$HOME/.dotfiles/":/home/fida/.dotfiles --network host niceda/debian:11.7
