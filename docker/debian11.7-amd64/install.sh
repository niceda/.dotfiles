#!/bin/bash
docker build -t niceda/debian:11.7-arm .
...
docker run -d --name dev -p 2222:22 -p 8000:8000 -p 8001:8001 -p 8002:8002 --privileged=true -v "$HOME/Documents/Code/qz/":/Users/fida/Documents/Code/qz -v "$HOME/.dotfiles/":/home/fida/.dotfiles niceda/debian:11.7-arm
